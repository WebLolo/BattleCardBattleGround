...
export async function TourIa({
  ...
  if (tourIa === 7){
    ...
    if(boardPlayer2.length === 7){
      ...
      if(cartePoubelle.length > 0){
        ...
        boardPositionSell(laCartePoubelle, boardPlayer2)
      ...
      if(cartePoubelle.length === 0 && cartePoubelle1.length > 0){
        ...
        boardPositionSell(laCartePoubelle1, boardPlayer2)
      ...
      while(goldPlayer2 > 3){
        ...
        if(planA.length > 0){
          ...
          if(boardPlayer2.length === 7){
            ...
            let cartePoubelle1 = boardPlayer2.filter(c => c.sousFamille !== cibleSousType).sort((a, b) => a.atk - b.atk)
            console.log("liste des moins pires cartes",cartePoubelle1)
            let cartePoubelle2 = boardPlayer2.filter(c => c.sousFamille === cibleSousType).sort((a, b) => a.lvl - b.lvl)
            ...
            if(cartePoubelle.length === 0 && cartePoubelle1.length === 0){
              ...
              if(laCartePoubelle2.lvl < planA[0].lvl){
                ...
                boardPositionSell(laCartePoubelle2, boardPlayer2)
  ...
  if(tourIa === 9){
    console.log("🎯 Tour 9 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if (tourIa === 10){
    console.log("🎯 Tour 10 - Objectif : Lvl up taverne + 1 carte opti");
    await sleep(1500); // (optionnel) délai de sécurité
    ...
    if(boardPlayer2.length === 7){
      await sleep(2000); // attente réaliste
      let cartePoubelle = boardPlayer2.filter(c => c.famille !== "Croc-Noir").sort((a, b) => a.atk - b.atk)
      let cartePoubelle1 = boardPlayer2.filter(c => c.sousFamille !== cibleSousType).sort((a, b) => a.lvl - b.lvl)
      if(cartePoubelle.length > 0){
        let laCartePoubelle = cartePoubelle[0]
        console.log(laCartePoubelle)
        boardPositionSell(laCartePoubelle, boardPlayer2)
      ...
      if(cartePoubelle.length === 0 && cartePoubelle1.length > 0){
        let laCartePoubelle1 = cartePoubelle1[0]
        if(laCartePoubelle1.lvl < planA[0].lvl){
          boardPositionSell(laCartePoubelle1, boardPlayer2)
          setBoardPlayer2(boardPlayer2.filter((c) => c.id !== laCartePoubelle1.id));
          boardPlayer2 = boardPlayer2.filter((c) => c.id !== laCartePoubelle1.id);
          setGoldPlayer2(goldPlayer2 + 1)
  ...
  if(tourIa === 11){
    console.log("🎯 Tour 11 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 12){
    console.log("🎯 Tour 12 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 14){
    console.log("🎯 Tour 14 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 15){
    console.log("🎯 Tour 15 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 16){
    console.log("🎯 Tour 16 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 17){
    console.log("🎯 Tour 17 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 18){
    console.log("🎯 Tour 18 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 19){
    console.log("🎯 Tour 19 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
  ...
  if(tourIa === 20){
    console.log("🎯 Tour 20 - Objectif : Opti board");
    await sleep(1500); // (optionnel) délai de sécurité
