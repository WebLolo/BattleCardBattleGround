...
// // // // // // // // // // // // // // // // // // 
function genererCarteVente(carte, emplacement) {
    return `
        <div class="card text-white bg-dark  mb-3 me-2 ${emplacement}" data-id="${carte.id}" style="width: 15rem;">
            <img class="card-img-top" src="${carte.img}" alt="Image de ${carte.nom}">
            <div class="card-body">
                <h5 class="card-title">${carte.nom}</h5>
                <div class="card-footer d-flex justify-content-between">
...
// // // // // // // // // // // // // // // // // // 
function genererCartePendantCombat(carte, emplacement, pv) {
    return `
        <div class="cardfight ${emplacement}" data-id="${carte.id}">
...
// ✅ Fonction pour mettre à jour l'affichage du board du joueur
function majAffichageBoardPendantCombat() {
    let boardContainer = document.querySelector(".playerBoard");
    boardContainer.innerHTML = "";
    
    for (let valeurCarte of boardAvantCombat) {
        pvCards.push(valeurCarte.hp);
    }
       
    
    boardAvantCombat.forEach(carte => {
        let index = 0;
        boardContainer.insertAdjacentHTML("beforeend", genererCartePendantCombat(carte, "boardCard", pvCards[index]));
        index++
    });
}
// // // // // // // // // // // // // // // // // // 
function genererCartePendantCombatIa(carte, emplacement, pv) {
    return `
        <div class="cardfight ${emplacement}" data-id="${carte.id}">
...
function majAffichageBoardPendantCombatIA() {
    let iaBoardContainer = document.querySelector(".iaBoard");
    iaBoardContainer.innerHTML = "";
    
    for (let valeurCarte of boardAvantCombatIa) {
        pvCardsIa.push(valeurCarte.hp);
    }
    
    boardAvantCombatIa.forEach(carte => {
        let index = 0;
        iaBoardContainer.insertAdjacentHTML("beforeend", genererCartePendantCombatIa(carte, "ia", pvCardsIa[index]));
        index++
    });
}
// // // // // // // // // // // // // // // // // // 
