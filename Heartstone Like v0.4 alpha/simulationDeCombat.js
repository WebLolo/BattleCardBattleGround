...
while(boardJoueurTest.length > 0 && boardIaTest.length > 0){
...
if(boardJoueurTest.length === 0 && boardIaTest.length > 0){
    console.log("le joueur perd cette manche")
}else if(boardIaTest.length === 0 && boardJoueurTest.length > 0){
    console.log("l'ia' perd cette manche")
}else{
    console.log("égalité")
}
