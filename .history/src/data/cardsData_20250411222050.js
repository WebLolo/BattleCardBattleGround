...
export const cards = [
  ...
  },
  {
    ...
    sousFamille : "Marin",
    texte: "*",
    criDeGuerreUnique: (carteCible, cartesource, board) => {
      let marinPresent = board.find(carte => carte.sousFamille === "Marin")
      console.log(marinPresent)
      if(marinPresent >= 0){
        if(carteCible.bivalenceMarinEffect){
          carteCible.atk += 2;
        }else{
          carteCible.atk += 1;
          cartesource.hp += 1;
