...
export const cards = [
  ...
  },
  {
    ...
    bivalenceSell: (cartesBoard) => {
      cartesBoard.forEach(carte => {
        if (carte.bivalenceMarinEffect === true) {
          carte.atk -= 2;
          carte.buffAtkBivalence -= 2;
          if(carte.buffHpBivalence === 0 && carte.buffAtkBivalence === 0){
            carte.bivalenceEffect = false
  ...
  },
  {
    ...
    bivalence: (cartesBoard) => {
      cartesBoard.forEach(carte => {
        ...
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Marin") {
          if (carte.bivalenceMarinEffect && !carte.bivalenceSources.includes("matriarche")) {
            carte.atk += 1;
            carte.buffAtkBivalence += 1;
            carte.bivalenceEffect = true;
            carte.bivalenceSources.push("matriarche");
          }
          if (!carte.bivalenceMarinEffect && carte.bivalenceSources.includes("matriarche")) {
            carte.atk -= 1;
            carte.buffAtkBivalence -= 1;
            carte.bivalenceSources = carte.bivalenceSources.filter(src => src !== "matriarche");
            if(carte.buffHpBivalence === 0 && carte.buffAtkBivalence === 0){
              carte.bivalenceEffect = false;
            }
          }
        ...
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Terrestre") {
          if (carte.bivalenceTerrestreEffect && !carte.bivalenceSources.includes("matriarche")) {
            carte.hp += 1;
    ...
    bivalenceSell: (cartesBoard) => {
      cartesBoard.forEach(carte => {
        ...
        if (carte.bivalenceTerrestreEffect === true) {
          carte.hp -= 1;
          carte.buffHpBivalence -= 1;
          if(carte.buffHpBivalence === 0 && carte.buffAtkBivalence === 0){
            carte.bivalenceEffect = false
    ...
    bivalenceSell: (cartesBoard, source) => {
      cartesBoard.forEach(carte => {
        ...
        if (carte.bivalenceSources.includes(source)) {
          ...
          carte.bivalenceSources = carte.bivalenceSources.filter(src => src !== source);
