...
export const cards = [
  ...
  },
  {
    ...
    bivalence: (cartesBoard, source) => {
      cartesBoard.forEach(carte => {
        if (!carte.bivalenceSources) carte.bivalenceSources = [];
    
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Marin") {
          if (carte.bivalenceMarinEffect && !carte.bivalenceSources.includes(source)) {
            carte.atk += 1;
            carte.buffAtkBivalence += 1;
            carte.bivalenceEffect = true;
            carte.bivalenceSources.push(source);
          }
          if (!carte.bivalenceMarinEffect && carte.bivalenceSources.includes(source)) {
            carte.atk -= 1;
            carte.buffAtkBivalence -= 1;
        ...
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Terrestre") {
          if (carte.bivalenceTerrestreEffect && !carte.bivalenceSources.includes(source)) {
            carte.hp += 1;
