  ...
  },
  {
    ...
    deathTrigger: (mortCarte, cartesBoard, self) => {
      ...
      if (self.bivalenceMarinEffect) {
        ...
        cible.atk += 1;
        cible.hp += 1;
        cible.buffAtkGrum = (cible.buffAtkGrum || 0) + 1;
  ...
  },
  {
      ...
      cartesBoard.forEach(carte => {
        ...
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Marin" && carte.nom === "LE REQUIN") {
          if (carte.bivalenceMarinEffect && !carte.bivalenceSources.includes("Brak'Na")) {
            ...
            carte.buffAtkBivalence += 2;
            carte.bivalenceEffect = true;
            carte.bivalenceMarinEffectUse = true;
            carte.bivalenceSources.push("Brak'Na");
          }
          if (!carte.bivalenceMarinEffect && carte.bivalenceSources.includes("Brak'Na") && carte.bivalenceMarinEffectUse === true) {
            carte.atk -= 2;
            carte.buffAtkBivalence -= 2;
            carte.bivalenceSources = carte.bivalenceSources.filter(src => src !== "Brak'Na");
            if(carte.buffHpBivalence === 0 && carte.buffAtkBivalence === 0){
              carte.bivalenceEffect = false;
              carte.bivalenceMarinEffectUse = false;
            }
          }
        }
        
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Marin" && carte.nom === "LE REQUIN") {
          if (carte.bivalenceTerrestreEffect && !carte.bivalenceSources.includes("Brak'Na1")) {
            carte.hp += 2;
            carte.buffHpBivalence += 2;
            carte.bivalenceEffect = true;
            carte.bivalenceTerrestreEffectUse = true;
            carte.bivalenceSources.push("Brak'Na1");
          }
          if (!carte.bivalenceTerrestreEffect && carte.bivalenceSources.includes("Brak'Na1") && carte.bivalenceTerrestreEffectUse === true) {
            carte.hp -= 2;
            carte.buffHpBivalence -= 2;
            carte.bivalenceSources = carte.bivalenceSources.filter(src => src !== "Brak'Na1");
            if(carte.buffHpBivalence === 0 && carte.buffAtkBivalence === 0){
              carte.bivalenceEffect = false;
              carte.bivalenceTerrestreEffectUse = false;
            }
          }
        }
      });
    ...
    bivalenceSell: (cartesBoard) => {
      cartesBoard.forEach(carte => {
        ...
        // Si la source est présente dans les effets appliqués
        if (carte.bivalenceSources.includes("Brak'Na") || carte.bivalenceSources.includes("Brak'Na1")) {
    
          // Retrait des effets appliqués par cette source
          if (carte.bivalenceMarinEffect && carte.bivalenceMarinEffectUse) {
            
            carte.atk -= 2;
            carte.buffAtkBivalence -= 2;
          }
    
          if (carte.bivalenceTerrestreEffect && carte.bivalenceTerrestreEffectUse) {
            carte.hp -= 2;
            carte.buffHpBivalence -= 2;
          }
