 ...
 
  {
    ...
    bivalence: (cartesBoard) => {
      cartesBoard.forEach(carte => {
        ...
        if (carte.famille === "Croc-Noir" && carte.sousFamille === "Marin" && carte.nom === "Tor'Grag des Profondeurs") {
          if (carte.bivalenceMarinEffect && !carte.bivalenceSources.includes("Tor'Grag")) {
            carte.atk += 2;
            carte.buffAtkBivalence += 2;
            carte.hp += 2;
            carte.buffHpBivalence += 2;
            carte.bivalenceEffect = true;
            carte.bivalenceSources.push("Tor'Grag");
          }
          if (!carte.bivalenceMarinEffect && carte.bivalenceSources.includes("Tor'Grag")) {
            carte.atk -= 2;
            carte.buffAtkBivalence -= 2;
            carte.hp -= 2;
            carte.buffHpBivalence -= 2;
            carte.bivalenceSources = carte.bivalenceSources.filter(src => src !== "Tor'Grag");
            if(carte.buffHpBivalence === 0 && carte.buffAtkBivalence === 0){
              carte.bivalenceEffect = false;
            }
          }
