  ...
  if (tourIa === 7){
    ...
    if(boardPlayer2 === 7){
      ...
      if(cartePoubelle.length > 0){
        setBoardPlayer2(boardPlayer2.filter((c) => c.id !== cartePoubelle.id));
        boardPlayer2 = boardPlayer2.filter((c) => c.id !== cartePoubelle.id);
        setGoldPlayer2(goldPlayer2 + 1)
        goldPlayer2 = goldPlayer2 + 1
        await sleep(2000); // attente réaliste
      }
      if(cartePoubelle.length === 0 && cartePoubelle1 > 0){
        setBoardPlayer2(boardPlayer2.filter((c) => c.id !== cartePoubelle1.id));
        boardPlayer2 = boardPlayer2.filter((c) => c.id !== cartePoubelle1.id);
        setGoldPlayer2(goldPlayer2 + 1)
        goldPlayer2 = goldPlayer2 + 1
        await sleep(2000); // attente réaliste
      }
      ...
      if(planA.length > 0){
        ...
        console.log("Bon je fais rien ce tour ce...")
      }
  }
}