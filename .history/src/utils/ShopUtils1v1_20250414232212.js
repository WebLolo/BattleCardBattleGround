...
export function fusionnerCartesIdentiques({ carteBase, deck, board, setDeck, setBoard, clone }) {
        ...
        if (copiesclone.length >= 3) {    
          ...
          setFusionAnim({
            cartes: copiesclone,         // les cartes à fusionner (non-dorées)
            carteResultat: carteDoree, // la carte dorée obtenue
          });
        ...
        if (copies.length >= 3) {
          ...
          setFusionAnim({
            cartes: copies,         // les cartes à fusionner (non-dorées)
            carteResultat: carteDoree, // la carte dorée obtenue
          });
          // 6. Ajouter la carte dorée au deck
          setDeck([...nouveauDeck, carteDoree]);
