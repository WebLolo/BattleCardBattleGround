...
export async function finDeCombat(cartesPlayer, cartesPlayer2, boardAvantCombat, boardAvantCombatPlayer2, lvlTaverne, lvlTavernePlayer2, setBoardPlayer, setBoardPlayer2, goldTour1, setgoldTour1, setGoldPlayer2, setplayerPv, setplayer2Pv, setGold, setShopCards, setActualPlayer){
...
export async function deroulerCombat1v1({
  ...
  aoe(cartesPlayer, cartesPlayer2, setBoardCombatPlayer2, setBoardCombat)
  
  await sleep(1000);
  aoe(cartesPlayer2, cartesPlayer, setBoardCombat, setBoardCombatPlayer2)
  await sleep(1000);
  ...
  finDeCombat(cartesPlayer, cartesPlayer2, boardAvantCombat, boardAvantCombatPlayer2, lvlTaverne, lvlTavernePlayer2, setBoardPlayer, setBoardPlayer2, goldTour1, setgoldTour1, setGoldPlayer2, setplayerPv, setplayer2Pv, setGold, setShopCards, setActualPlayer)
