  ...
  if (tourIa === 3) {
    ...
    while (gold >= 3) {
      ...
      if (!carte) {
        ...
        refreshRef.current?.(); // simule clic sur bouton
        await waitForShopUpdate(previous); // on attend vraiment le changement
        await sleep(2000); // 🛑 délai de sécurité visuel et logique
        continue;
      }
