  ...
  if (tourIa === 3) {
    ...
    while (goldPlayer2 >= 3) {
      ...
      if (!carte) {
        ...
        actualiserBoutique({
            lvlTavernePlayer2, setShopCards, goldPlayer2, actualPlayer: 2
        });
        await sleep(1000);
      ...
      console.log("or restant", goldPlayer2)
    ...
    if (goldPlayer2 >= 3) {
      ...
      if (carteFallback) {
        ...
        acheterCarte({
          card: carteFallback,
          goldPlayer2,
          setGoldPlayer2: (g) => (goldPlayer2 = g),
          deckPlayer2,
          setDeckPlayer2,
          shopCards,
          setShopCards,
  ...
  if (tourIa === 4){
    ...
    while (goldPlayer2 > 3){
      ...
      if (!carte) {
        console.log("🔁 Pas de carte Croc-Noir sous-type en shop, actualisation...");
        actualiserBoutique({
            lvlTavernePlayer2, setShopCards, goldPlayer2, actualPlayer: 2, setGoldPlayer2: (g) => (goldPlayer2 = g), 
        });
        await sleep(1000);
        continue; // Reboucle sur nouveau shop
      }
