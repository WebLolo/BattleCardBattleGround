import { acheterCarteIA, coutLvlTaverne, getCartesAleatoires, getCartesPourShop, getNombreCartesShop, clonerCarte, calculOrProchainTour } from "@/utils/shopUtils";
...
console.log(goldTour1)
calculOrProchainTour(goldTour1, setgoldTour1)
console.log(goldTour1)
setGoldIA(goldTour1)
setGold(goldTour1)
