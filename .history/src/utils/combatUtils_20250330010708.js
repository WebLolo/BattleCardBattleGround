import { acheterCarteIA, coutLvlTaverne, getCartesAleatoires, getCartesPourShop, getNombreCartesShop, clonerCarte } from "@/utils/shopUtils";
...
function tourIA ({ lesCards, lesGoldIA, leSetGIA, leBoardDeIA, leSetBDIA}){
  acheterCarteIA ({ lesCards, lesGoldIA, leSetGIA, leBoardDeIA, leSetBDIA })
}
...
export async function deroulerCombatReact({
  ...
  tourIA(cards, goldIA, setGoldIA, boardIA, setBoardIA)
  console.log(boardIA)
