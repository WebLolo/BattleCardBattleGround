...
export async function deroulerCombat1v1({
  ...
  await sleep(400);
  // Côté joueur 1
  const oneTicResult1 = await oneTicDebutCombat(cartesPlayer, cartesPlayer2);
  cartesPlayer2 = oneTicResult1.cartesCible;

  // Côté joueur 2
  const oneTicResult2 = await oneTicDebutCombat(cartesPlayer2, cartesPlayer);
  cartesPlayer = oneTicResult2.cartesCible;
  await sleep(400);
