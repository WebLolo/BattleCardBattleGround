...
export function piocherCarte( sourceType, targetType, draggedCard, deck, setDeck, boardPlayer, setBoardPlayer ){
...
export function piocherCarteSpe( sourceType, targetType, draggedCard, deck, setDeck, boardPlayer, setBoardPlayer ){
    if (sourceType === "deck" && targetType === "board-drop" && draggedCard.piocherCarteSpe === true && boardPlayer.length <7) {
        ...
        const futurDeck = [...nouveauDeck, clone]; // ✅ ici, clone est bien inclus
        fusionnerCartesIdentiques({
            carteBase: clone,
            deck: futurDeck,
            board: boardPlayer,
