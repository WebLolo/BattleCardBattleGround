...
import { aoe, boardPositionFight, degatsAdj, oneTicDebutCombat } from "@/utils/mecaUtils";
...
export async function deroulerCombat1v1({
  ...
  await sleep(400);
  const oneTicDebutCombatResult = await oneTicDebutCombat(cartesPlayer, cartesPlayer2);
  cartesPlayer2 = oneTicDebutCombatResult.cartesPlayer2;
  const oneTicDebutCombatResult1 = await oneTicDebutCombat(cartesPlayer2, cartesPlayer);
  cartesPlayer = oneTicDebutCombatResult1.cartesPlayer;
