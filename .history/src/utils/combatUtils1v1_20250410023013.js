...
import { aoe, boardPositionFight, degatsAdj, onTicDebutCombat } from "@/utils/mecaUtils";
...
export async function deroulerCombat1v1({
  ...
  await sleep(400);
  const onTicDebutCombatResult = await onTicDebutCombat(cartesPlayer, cartesPlayer2);
  cartesPlayer2 = onTicDebutCombatResult.cartesPlayer2;
  const onTicDebutCombatResult1 = await onTicDebutCombat(cartesPlayer2, cartesPlayer);
  cartesPlayer = onTicDebutCombatResult1.cartesPlayer;
