...
function acheterCarteIa(carteCible,planA,setDeckPlayer2,deckPlayer2,setGoldPlayer2,goldPlayer2,setShopCards,shopCards){
  carteCible = planA[0]
...
function jouerCarteDeckIa(deckPlayer2,setDeckPlayer2,boardPlayer2,setBoardPlayer2,carteCible){
  deckPlayer2.shift()
  console.log(deckPlayer2)
  setDeckPlayer2([])
...
function actionActualiserShopIa(actualiserBoutiqueIA,lvlTavernePlayer2,setShopCards,goldPlayer2,setGoldPlayer2,shopCards){
    ...
    let carteCible = []
      ...
      while(goldPlayer2 > 3){
        ...
        if(planA.length > 0){
          ...
          goldPlayer2 = acheterCarteIa(carteCible,planA,setDeckPlayer2,deckPlayer2,setGoldPlayer2,goldPlayer2,setShopCards,shopCards)
          console.log(goldPlayer2)
          await sleep(2000); // attente réaliste
          jouerCarteDeckIa(deckPlayer2,setDeckPlayer2,boardPlayer2,setBoardPlayer2,carteCible)
        }else{
          actionActualiserShopIa(actualiserBoutiqueIA,lvlTavernePlayer2,setShopCards,goldPlayer2,setGoldPlayer2,shopCards)
        }
      }
      if(goldPlayer2 === 3){
