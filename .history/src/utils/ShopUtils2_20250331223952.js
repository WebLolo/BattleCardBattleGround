...
export const actualiserBoutique = ({ lvlTaverne, setShopCards, gold, setGold, actualPlayer, goldPlayer2, lvlTavernePlayer2 }) => {
  if(actualPlayer === 1){
    if (gold < 1) {
  ...
  if(actualPlayer === 2){
    ...
    setShopCards(cartes);
    setGold(goldPlayer2 - 1)
  }

};

export const lvlUpTaverne = ({ gold, lvlTaverne, setGold, setLvlTaverne, setShopCards, actualPlayer, goldPlayer2, lvlTavernePlayer2, setGoldPlayer2 }) => {
  ...
  if(actualPlayer === 2){
    const cout = coutLvlTaverne[lvlTavernePlayer2];
    if (goldPlayer2 < cout) {
      alert("💰 Pas assez d'or pour monter de niveau !");
      return;
    }
