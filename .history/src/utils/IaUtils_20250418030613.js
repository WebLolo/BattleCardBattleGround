      ...
      while(goldPlayer2 > 3){
        ...
        if(planA.length > 0){
          ...
          if(boardPlayer2.length === 7){
            ...
            let cartePoubelle2 = crocs.filter(c => c.sousFamille === cibleSousType).sort((a, b) => a.atk - b.atk)
            ...
            if(cartePoubelle.length === 0 && cartePoubelle1.length === 0){
              ...
              if(laCartePoubelle2.atk < planA[0].atk){
                ...
                console.log("Actualisons la taverne")
                let newShop = actualiserBoutiqueIA({
                  lvlTavernePlayer2, setShopCards: setShopCards, goldPlayer2, actualPlayer: 2, setGoldPlayer2
                });
                setGoldPlayer2(goldPlayer2 - 1)
          ...
          if(boardPlayer2.length < 7 && goldPlayer2 === 3){
            console.log(boardPlayer2)
            carteCible = planA[0]
