...
function applicationEffectIa(boardPlayer2, carteAPoser, setBoardPlayer2, deckPlayer2, setDeckPlayer2, setFusionAnim){
  ...
  if(carteAPoser.piocherCarteSpe){
    piocherCarteSpeIa( carteAPoser, deckPlayer2, setDeckPlayer2, boardPlayer2, setBoardPlayer2, setFusionAnim )
  }
}
    ...
    if (goldPlayer2 >= 3) {
      ...
      if (nouvelleCarte && boardPlayer2.length < 7) {
        ...
        if(nouvelleCarte.piocherCarteSpe){
          await sleep(2000);
          let boardPlayer2Spe = [...boardPlayer2, nouvelleCarte]
          let carteSpe = piocherCarteSpeIa( nouvelleCarte, deckPlayer2, setDeckPlayer2, boardPlayer2Spe, setBoardPlayer2, setFusionAnim )
          jouerCarteDepuisDeck(carteSpe);
        }
      }
