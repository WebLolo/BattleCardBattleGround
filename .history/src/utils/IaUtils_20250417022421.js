...
function applicationEffectIa(boardPlayer2, carteAPoser, setBoardPlayer2){
  ...
  if(carteAPoser.piocherCarteSpe){
    piocherCarteSpe( draggedCard, deckPlayer2, setDeckPlayer2, boardPlayer2, setBoardPlayer2, setFusionAnim )
  }
}
  ...
  if (tourIa === 3) {
    ...
    while (gold >= 3) {
      ...
      if (deck.length > 0 && boardPlayer2.length < 7) {
        ...
        applicationEffectIa(boardPlayer2, carteAPoser)
