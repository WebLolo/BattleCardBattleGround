...
export async function TourCombat(nomAttaquant, attaquant, nomDefenseur, defenseur, setCarteAttaquantId, setCarteDefenseurId){
...
export async function deroulerCombat1v1({
  ...
  while (cartesPlayer.length > 0 && cartesPlayer2.length > 0) {
      ...
      if(attaquant.furieUse){
        ...
        TourCombat(nomAttaquant, attaquant, nomDefenseur, defenseur, setCarteAttaquantId, setCarteDefenseurId)
      }
