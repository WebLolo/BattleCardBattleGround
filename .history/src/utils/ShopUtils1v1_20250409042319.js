...
export const clonerCarte = ({ carte, camp }) => {
  return {
      ...
      bivalenceMarinEffectUse: carte.bivalenceMarinEffect !== undefined ? carte.bivalenceMarinEffect : false,
      bivalenceTerrestreEffectUse: carte.bivalenceTerrestreEffect !== undefined ? carte.bivalenceTerrestreEffect : false,
