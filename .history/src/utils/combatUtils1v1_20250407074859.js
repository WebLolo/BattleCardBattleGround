...
import { aoe } from "@/utils/mecaUtils";
  ...
  while (cartesPlayer.length > 0 && cartesPlayer2.length > 0) {
    ...
    let attaquant = joueurAttaquant
      if (joueurAttaquant === true){
        ...
        let nbRandom = entierAleatoire(0, cartesPlayer2.length -1)
        defenseur = cartesPlayer2[nbRandom]
      }
      if (joueurAttaquant === false){
        ...
        let nbRandom1 = entierAleatoire(0, cartesPlayer2.length -1)
        defenseur = cartesPlayer[nbRandom1]
      } 
    ...
    if(attaquant.nom === "Zog'Bar le Vent d'Acier" && nomDefenseur === "joueur2" && cartesPlayer2.length > 1){
      ...
      }else if(nbRandom === cartesPlayer2.length){
        cartesPlayer2[nbRandom - 1].hp -= attaquant.atk
      }else{
        cartesPlayer2[nbRandom - 1].hp -= attaquant.atk
        cartesPlayer2[nbRandom + 1].hp -= attaquant.atk
      }
