  ...
  if (tourIa === 3) {
    ...
    while (gold >= 3) {
      ...
      if (!carte) {
        ...
        actualiserBoutique({
            lvlTavernePlayer2, setShopCards, goldPlayer2: gold, actualPlayer: 2, setGoldPlayer2
        });
        await sleep(1000);
    ...
    while (gold >= 3){
      ...
      if (!carte) {
        ...
        let newShop = actualiserBoutiqueIA({
            lvlTavernePlayer2, setShopCards: setShopCards, goldPlayer2: gold, actualPlayer: 2, setGoldPlayer2, shopCards
        });
