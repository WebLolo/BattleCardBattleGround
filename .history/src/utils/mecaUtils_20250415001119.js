...
export function piocherCarteSpe( sourceType, targetType, draggedCard, deck, setDeck, boardPlayer, setBoardPlayer, setFusionAnim, setFusionAnimation ){
    if (sourceType === "deck" && targetType === "board-drop" && draggedCard.piocherCarteSpe === true && boardPlayer.length <7) {
        ...
        setDeck([...nouveauDeck, clone]);
        if(draggedCard.estDoree && draggedCard.piocherCarteSpe){
