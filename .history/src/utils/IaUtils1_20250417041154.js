...
export async function TourIa({
  ...
  if (tourIa === 1) {
    if (goldPlayer2 >= 3) {
      ...
      if(cible.criDeGuerreUnique && boardPlayer2.length > 0){
      ...
      if (nouvelleCarte && boardPlayer2.length < 7) {
        ...
        if(nouvelleCarte.piocherCarteSpe){
          ...
          boardPlayer2.push(nouvelleCarte)
          boardPlayer2.push(carteSpe)
        }
      }
    ...
    while (gold >= 3) {
      ...
      if (deck.length > 0 && boardPlayer2.length < 7) {
        ...
        if(carteAPoser.piocherCarteSpe){
          ...
          let carteSpe = piocherCarteSpeIa( carteAPoser, deckPlayer2, setDeckPlayer2, boardPlayer2, setBoardPlayer2, setFusionAnim )
          await sleep(2000);
      
          setBoardPlayer2([...boardPlayer2, carteSpe]);
          setDeckPlayer2([...deckPlayer2]);
        }
