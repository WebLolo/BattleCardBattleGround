...
export async function TourIa({
  ...
  if (tourIa === 3) {
    ...
    while (gold >= 3) {
      ...
      const nouveauBoard = [...boardPlayer2, carte]
      ...
      if(marinsB > terrestresB && carte.sousFamille === "Marin"){
        carte.bivalenceMarinEffect = true
      }
      if(marinsB > terrestresB && carte.sousFamille === "Terrestre"){
    ...
    if (gold >= 3) {
      ...
      if (carteFallback) {
        ...
        if (deck.length > 0 && boardPlayer2.length < 7) {
          ...
          const nouveauBoard = [...boardPlayer2, carteAPoser]
          const marinsB = nouveauBoard.filter(c => c.sousFamille === "Marin").length;
          const terrestresB = nouveauBoard.filter(c => c.sousFamille === "Terrestre").length;
          ...
          if(marinsB > terrestresB && carteAPoser.sousFamille === "Terrestre"){
            ...
            if(carteAPoser.nom === "Tor'Grag des Profondeurs"){
              carteAPoser.furieUse = true
              carteAPoser.provocationUse = false
            }
          }
          if(marinsB < terrestresB && carteAPoser.sousFamille === "Marin"){
