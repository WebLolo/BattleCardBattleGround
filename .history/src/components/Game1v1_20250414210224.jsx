        ...
        if(actualPlayer === 1){
            ...
            if (sourceType === "shop" && targetType === "footer" && gold >= 3) {
              ...
              vendreCarteDuBoard(draggedCard);
                ...
                const deckSansDraggedCard = deck.filter((c) => c.id !== draggedCard.id);
                ...
                if (cloneSpe) {
                    fusionnerCartesIdentiques({
                        carteBase: cloneSpe,
                        deck: [...deckSansDraggedCard, cloneSpe],
                        board: boardPlayer,
                        setDeck,
                        setBoard: setBoardPlayer
                    });
            ...
            const updatedDeck = piocherCarteSpe(
                sourceType, targetType, draggedCard,
                deck, setDeck, boardPlayer, setBoardPlayer
              );
