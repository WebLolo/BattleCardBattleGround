...
export default function GameIA(){
    ...
    const [shopCards, setShopCards] = useState(() => {
        ...
        const cartesShopAvantClone = getCartesAleatoires(tirage, getNombreCartesShop(lvlTaverne));
        console.log(cartesShopAvantClone)
        let cartesApresClone = [{}]
        cartesShopAvantClone.forEach(element => {
            cartesApresClone.push(clonerCarte(element, "joueur"))
        });
