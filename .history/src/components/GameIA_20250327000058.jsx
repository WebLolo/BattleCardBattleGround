  ...
  return (
    <DndContext onDragEnd={handleDragEnd}>
      <GameLayout
        ...
        shop={phase === "shop" ? <Shop cards={shopCards} origin="shop" setPreviewCard={setPreviewCard} /> : null}
        boardBottom={
          <DropZone id="board-drop">
            <Board cards={boardJoueur} origin="board" setPreviewCard={setPreviewCard} />
          </DropZone>
        }
        footer={
          <>
            <DropZone id="footer" className="drop-footer">
              <Deck cards={deck} onPlay={jouerCarteDepuisDeck} setPreviewCard={setPreviewCard} />
            </DropZone>
            <PlayerHUD
              name="Joueur"
              hp={30}
