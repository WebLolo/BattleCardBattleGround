...
export default function Card({
  ...
  return (
    ...
    >
      <motion.div
        animate={controls}
        className={`cardfight player content-card ${shouldAnimate ? "animate__animated animate__backInLeft" : ""}${card.animAoE ? "aoe-hit" : ""}`}
        data-id={card.id}
      ...
      >
        ...
        {degatsAffiches !== null && (
          <>
            <DamagePopup amount={degatsAffiches} />
          </>
        )}
      </motion.div>
    </div>
