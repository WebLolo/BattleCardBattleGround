        ...
        useEffect(() => {
          ...
          useEffect(() => {
            if (phase === "shopPlayer2") {
              TourIa(goldPlayer2, setGoldPlayer2, shopCards, setShopCards, deckPlayer2, setDeckPlayer2, lvlTavernePlayer2, boardPlayer2, jouerCarteDepuisDeck, tourIa, setTourIa);
            }
          }, [phase]);
        return (
