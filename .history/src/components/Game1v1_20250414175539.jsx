...
export default function Game1v1(){
    ...
    function fusionnerCartesIdentiques({ carteBase, actualPlayer, deck, board, setDeck, setDeckPlayer2, setBoard, setBoardPlayer2 }) {
        const deckActuel = actualPlayer === 1 ? deck : deckPlayer2;
        const boardActuel = actualPlayer === 1 ? board : boardPlayer2;
      
        const setDeckActuel = actualPlayer === 1 ? setDeck : setDeckPlayer2;
        const setBoardActuel = actualPlayer === 1 ? setBoard : setBoardPlayer2;
      
        // 1. Regrouper toutes les cartes du joueur
        const toutesCartes = [...deckActuel, ...boardActuel];
        ...
        if (copies.length >= 3) {
          ...
          // 5. Supprimer les 3 premières copies
          let àRetirer = 3;
          const nouveauDeck = [];
          const nouveauBoard = [];
      
          for (const carte of deckActuel) {
          ...
          for (const carte of boardActuel) {
            if (carte.nom === carteBase.nom && àRetirer > 0) {
              àRetirer--;
            } else {
          ...
          // 6. Ajouter la carte dorée
          setDeckActuel([...nouveauDeck, carteDoree]);
          setBoardActuel(nouveauBoard);
        }
      }
        ...
        if(actualPlayer === 1){
            ...
            if (sourceType === "shop" && targetType === "footer" && gold >= 3) {
              ...
              fusionnerCartesIdentiques({
                ...
                actualPlayer,
                deck: actualPlayer === 1 ? deck : deckPlayer2,
                board: actualPlayer === 1 ? boardPlayer : boardPlayer2,
                setDeck,
                setDeckPlayer2,
        ...
        if(actualPlayer === 2){
            ...
            if (sourceType === "shop" && targetType === "footer" && goldPlayer2 >= 3) {
              ...
              fusionnerCartesIdentiques({
                carteBase: draggedCard,
                actualPlayer,
                deck: actualPlayer === 2 ? deck : deckPlayer2,
                board: actualPlayer === 2 ? boardPlayer : boardPlayer2,
                setDeck,
                setDeckPlayer2,
                setBoard: setBoardPlayer,
                setBoardPlayer2
