    ...
    const handleDragEnd = (event) => {
        if(actualPlayer === 1){
            ...
            if (sourceType === "shop" && targetType === "footer" && gold >= 3) {
                ...
                // ✅ Drush la Poissonneuse ou autre pioche spéciale
                ...
                if (cloneSpe) {
                  ...
                  // Sinon vérifie s'il faut fusionner avec draggedCard lui-même
                  fusionnerCartesIdentiques({
                    carteBase: draggedCard,
                    deck: nouveauDeck,
                    board: boardPlayer,
                ...
                setDeck(nouveauDeck); // appliquer le deck mis à jour
              }
