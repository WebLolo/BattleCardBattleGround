...
export default function Card({
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      console.log("💡 Card render:", card.nom, "ATK:", card.atk, "BaseAtk:", card.baseAtk);
    }, [card]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={`hudIntPv ${phase === "combat" && card.hp < card.hpCombat ? "pv-damaged" : ""}${card.hp > card.baseHp ? "buffed" : ""} ${pulseHp ? "pulse" : ""}`}>{card.hp}</p>
