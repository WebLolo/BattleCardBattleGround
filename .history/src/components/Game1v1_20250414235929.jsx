...
export default function Game1v1(){
    ...
    const handleDragEnd = (event) => {
        if(actualPlayer === 1){
            ...
            piocherCarteSpe( sourceType, targetType, draggedCard, deck, setDeck, boardPlayer, setBoardPlayer, setFusionAnimation )
        ...
        if(actualPlayer === 2){
            ...
            piocherCarteSpe( sourceType, targetType, draggedCard, deckPlayer2, setDeckPlayer2, boardPlayer2, setBoardPlayer, setFusionAnimation )
        }
