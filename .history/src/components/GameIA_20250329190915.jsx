...
export default function GameIA(){
    ...
    const appliquerCriDeGuerreSurUneCible = (cartesBoard, effet) => {
    ...
    const handleDragEnd = (event, appliquerCriDeGuerreSurUneCible) => {
        ...
        if (sourceType === "deck" && draggedCard.criDeGuerre) {
            ...
            if (draggedCard.cibleUnique) {
                console.log(`🎯 Cri de guerre ciblé sur UNE seule carte pour ${draggedCard.nom}`);
                appliquerCriDeGuerreSurUneCible(boardPlayer, draggedCard.criDeGuerre);
            } else {
