  ...
  return (
    <DndContext onDragEnd={handleDragEnd}>
      <GameLayout
        ...
        shop={phase === "shop" ? <Shop cards={shopCards} origin="shop" onPreview={setPreviewCard} /> : null}
        boardBottom={
          <DropZone id="board-drop">
            <Board cards={boardJoueur} origin="board" onPreview={setPreviewCard} />
          </DropZone>
        }
        footer={
          <>
            <DropZone id="footer" className="drop-footer">
              <Deck cards={deck} onPlay={jouerCarteDepuisDeck} onPreview={setPreviewCard} />
            </DropZone>
            <PlayerHUD
              name="Joueur"
              hp={30}
      ...
      />
      <CardPreview card={previewCard} onClose={() => onPreview(null)} />
    </DndContext>
  );
}
