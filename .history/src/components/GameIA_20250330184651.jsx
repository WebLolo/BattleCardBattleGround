...
export default function GameIA(){
    ...
    const handleDragEnd = (event) => {
        ...
        if (sourceType === "deck" && targetType === "board" && draggedCard.sangNoble) {
            console.log(`📢 Sang Noble activé pour ${draggedCard.nom}`);
            draggedCard.sangNoble(boardPlayer)
        }
        if (sourceType === "deck" && targetType === "board" && draggedCard.effetDeCouple){
            appliquerEffetDeCouple(draggedCard, boardPlayer)
        }
        if (sourceType === "deck" && targetType === "board" && draggedCard.aura) {
