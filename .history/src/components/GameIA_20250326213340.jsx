...
export default function GameIA() {
  ...
  // 🏪 Génération du shop au lancement
  useEffect(() => {
    const cartesDisponibles = getCartesPourShop(lvlTaverne);
    const tirage = getCartesAleatoires(cartesDisponibles, 3);
    setShopCards(tirage);
  }, []);
  ...
  const fakeBoardIA = [
    { id: 9991, name: "Dragon IA", atk: 4, hp: 6, imgMinia: "/img/card1.png" },
    { id: 9992, name: "Golem IA", atk: 3, hp: 8, imgMinia: "/img/card2.png" },
  ];
