...
import { bivalence, piocherCarte, boardPositionSell, addBoardPosition } from "@/utils/mecaUtils";
export default function Game1v1(){
    ...
    useEffect(() => {
        const nbCrocNoirMarin = boardPlayer.filter(
          (c) => c.famille === "Croc-Noir" && c.sousFamille === "Marin"
        ).length;
        console.log("Nombre de Croc-Noir Marins :", nbCrocNoirMarin);
    }, [boardPlayer]);

    useEffect(() => {
        const nbCrocNoirTerrestre = boardPlayer.filter(
          (c) => c.famille === "Croc-Noir" && c.sousFamille === "Marin"
        ).length;
        console.log("Nombre de Croc-Noir Marins :", nbCrocNoirTerrestre);
    }, [boardPlayer]);
    ...
    const handleDragEnd = (event) => {
        if(actualPlayer === 1){
            ...
            bivalence(sourceType, targetType, draggedCard, deck, setMarinsCount, marinsCount, setTerrestresCount, terrestresCount, boardPlayer, nbCrocNoirTerrestre, nbCrocNoirMarin)
        ...
        if(actualPlayer === 2){
            ...
            bivalence(sourceType, targetType, draggedCard, deckPlayer2, setMarinsCountPlayer2, marinsCountPlayer2, setTerrestresCountPlayer2, terrestresCountPlayer2, boardPlayer2)
