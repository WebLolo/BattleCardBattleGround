...
export default function Card({
  ...
  useEffect(() => {
    ...
    return (
      ...
      >
        {/* 🛡️ Overlay provocation */}
        {card.provocation && card.provocationUse && (
          <img
            src={card.imgProvocOverlay}
            alt="Provocation Overlay"
            className="provoc-background"
          />
        )}
